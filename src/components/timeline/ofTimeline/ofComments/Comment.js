...
function Comment(props) {
  const { isRoot, isActionable, classes, id, threadId, fname, lname, avatar, date, text } = props;
      ...
      <ListItem alignItems="flex-start" className={classes.ListItem} key={id}>
        ...
        <ListItemText>
          ...
          {isEditing ? (
            ...
            <Typography color="textSecondary" display="block" variant="body2" style={{ fontSize: '13px' }}>
              {text}
            </Typography>
          )}
        </ListItemText>
