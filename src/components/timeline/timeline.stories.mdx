...
export const onEntityDelete = (entityId, callback) => { 
  action('onEntityDelete')(entityId, 'callback');
  if (callback) setTimeout(callback, 3000);
}
export const onEntityUpdate = (entityId, payload, callback) => { 
  action('onEntityUpdate')(entityId, 'callback');
  if (callback) setTimeout(callback, 3000);
}
export const onEntityCreate = (payload, callback) => { 
  action('onEntityCreate')(payload, 'callback');
  if (callback) setTimeout(callback, 3000);
}
    ...
    <State store={plainTimelineStore}>
      {state =>
        <Timeline
          ...
          onInstanceCreate={action('onInstanceCreate')}
...
<Preview>
  <Story name="Partials » Entities (Clips)">
    <Entities
      ...
      onEntityCreate={onEntityCreate}
      onEntityDelete={onEntityDelete}
      onEntityUpdate={action('onEntityUpdate')}
      onInstanceCreate={action('onInstanceCreate')}
      onInstanceDelete={action('onInstanceDelete')}
      onInstanceUpdate={action('onInstanceUpdate')}
      suggestions={[]}
...
<Preview>
  <Story name="Partials » Entities (Tags)">
    <Entities
      ...
      onInstanceDelete={action('onInstanceDelete')}
      onInstanceUpdate={action('onInstanceUpdate')}
      suggestions={data.project.projecttags}
      type="tags"
    />
  </Story>
</Preview>
...
<Preview>
  <Story name="Partials » Entities (Places)">
    <Entities
      ...
      onInstanceDelete={action('onInstanceDelete')}
      onInstanceUpdate={action('onInstanceUpdate')}
      suggestions={data.project.projectplaces}
      type="places"
    />
  </Story>
</Preview>
